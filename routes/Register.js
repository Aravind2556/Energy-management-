...
const Energy = [
    ...
    },
    {
        ...
        "power_factor": 54,
        "temperature": 0.35,
        "timestamp": "2025-01-29T12:20:00Z"
    },
    {
        "id": 5,
        "power": 17,
        ...
        "power_factor": 55,
        "temperature": 0.32,
        "timestamp": "2025-01-29T12:25:00Z"
    },
...
const phase2 = [
    {
        ...
        "power_factor": 56,
        "temperature": 0.29,
        "timestamp": "2025-01-29T13:25:00Z"
    },
    {
        "id": 18,
        "power": 28,
    ...
    },
    {
        ...
        "power_factor": 53,
        "temperature": 0.34,
        "timestamp": "2025-01-29T13:35:00Z"
    },
    {
        "id": 20,
        "power": 27,
...
const phase3 = [
    ...
    },
    {
        ...
        "power_factor": 50,
        "temperature": 0.27,
        "timestamp": "2025-01-29T13:10:00Z"
    },
    {
        "id": 15,
        "power": 19,
    ...
    },
    {
        ...
        "power_factor": 54,
        "temperature": 0.24,
        "timestamp": "2025-01-29T13:20:00Z"
    }
]



router.get('/fetch-Phase1', async (req, res) => {
    try{
         const engry =  Energy
         if(engry){
            return res.json({success : true , data : engry})
         }
         else{
            return res.json({success : false , message : "cant find please try again later"})
         }
...
router.get('/fetch-Phase2', async (req, res) => {
    try{
         const engry =  phase2
         if(engry){
            return res.json({success : true , data : engry})
...
router.get('/fetch-Phase3', async (req, res) => {
    try{
         const engry =  phase3
         if(engry){
            return res.json({success : true , data : engry})
